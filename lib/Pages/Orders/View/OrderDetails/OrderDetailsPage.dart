...
class OrderDetailsPage extends StatelessWidget {
  ...
  OrderDetailsPage(this.order, {this.isActiveOrder = false, Key? key})
      : super(key: key) {
    orderCtrlObj.singleOrderData = order;
  }
        ...
        slivers: [
          SliverAppBar(
            ...
            actions: [
              ...
              AppStyles.p12p5(
                CustomButton(
                  btnTxt: (isActiveOrder) ? 'add_item'.tr : 'edit_order'.tr,
                  onTap: () async {
              ...
              [
                ...
                GetBuilder(builder: (OrderController orderCtrlObj) {
                  return ListView.builder(
                    ...
                    itemCount: order.sellLines.length,
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      ...
                      Text(
                        AppFormat.doubleToStringUpTo2(order.totalBeforeTax) ??
                            '',
                        style: Theme.of(context).textTheme.bodySmall,
                      ),
                    ],
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      ...
                      Text(
                        AppFormat.doubleToStringUpTo2(order.taxAmount) ?? '',
                        style: Theme.of(context).textTheme.bodySmall,
                      ),
                    ],
                  ),
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      ...
                      Text(
                        AppFormat.doubleToStringUpTo2(order.discountAmount) ??
                            '',
                        style: Theme.of(context).textTheme.bodySmall,
                      ),
                    ],
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      ...
                      Text(
                        AppFormat.doubleToStringUpTo2(order.totalPaid) ?? '',
                        style: Theme.of(context).textTheme.bodySmall,
                      ),
                    ],
                  ),
                ...
                Container(
                  ...
                  child: Row(
                      ...
                      children: <Widget>[
                        ...
                        Text(
                          AppFormat.doubleToStringUpTo2(order.finalTotal) ?? '',
                          style: Theme.of(context).textTheme.bodySmall,
                        ),
                      ]),
                ),
                ...
                Container(
                  ...
                  child: Row(
                      ...
                      children: <Widget>[
                        ...
                        Text(
                          ((double.tryParse('${order.finalTotal}') ?? 0.0) -
                                  (double.tryParse(
                                          '${order.totalAmountRecovered}') ??
                                      0.0))
                              .toString(),
        ...
        children: [
          ...
          GetBuilder(builder: (OrderController orderCtrlObj) {
            return (isActiveOrder &&
                    orderCtrlObj.isAnyOrderMarked() /* && isItCooked()*/)
                ? CustomButton(
