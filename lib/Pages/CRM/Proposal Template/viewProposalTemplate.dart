...
class ViewProposalTemplate extends StatefulWidget {
  const ViewProposalTemplate({super.key});

  @override
  State<ViewProposalTemplate> createState() => _ViewProposalTemplateState();
}

class _ViewProposalTemplateState extends State<ViewProposalTemplate> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('View Proposal Template'),
      ),
      body: Column(
        children: [
          Container(
