...
class DocumentsTabTile extends StatefulWidget {
  DocumentsTabTile(
      {Key? key,})
      : super(key: key);

  @override
  State<DocumentsTabTile> createState() => _DocumentsTabTileState();
}

class _DocumentsTabTileState extends State<DocumentsTabTile> {
  @override
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  BodyHeadingTile(
                    heading: 'Created At:',
                    body: AppFormat.dateOnly(DateTime.now()),
                  ),
                  BodyHeadingTile(
                    heading: 'Updated At:',
                    body: AppFormat.dateOnly(DateTime.now()),
