...
class FollowUpDropDown extends StatefulWidget {
  const FollowUpDropDown({super.key});
        ...
        builder: (LeadsController leadsController) {
          return DropdownButtonHideUnderline(
            child: DropdownButton2(
              ...
              items: leadsController.followUpTypeList.map((String items) {
              ...
              value: leadsController.statusFollowUp,
              ...
              onChanged: (String? value) {
                setState(() {
                  leadsController.statusFollowUp = value;
                });
              },
