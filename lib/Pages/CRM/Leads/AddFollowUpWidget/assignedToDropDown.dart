...
class AssignedToDropDown extends StatefulWidget {
  const AssignedToDropDown({super.key});
        ...
        builder: (LeadsController leadsController) {
          return DropdownButtonHideUnderline(
            child: DropdownButton2(
              ...
              items: leadsController.assignedToList.map((String items) {
              ...
              value: leadsController.statusAssignedTo,
              ...
              onChanged: (String? value) {
                setState(() {
                  leadsController.statusAssignedTo = value;
                });
              },
