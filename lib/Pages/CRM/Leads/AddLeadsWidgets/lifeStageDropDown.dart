...
class LifeStageDropDown extends StatefulWidget {
  const LifeStageDropDown({super.key});

  @override
  State<LifeStageDropDown> createState() => _LifeStageDropDownState();
}

class _LifeStageDropDownState extends State<LifeStageDropDown> {
  @override
        ...
        builder: (LeadsController leadsController) {
          return DropdownButtonHideUnderline(
            child: DropdownButton2(
              ...
              value: leadsController.statusLifeStage,
              ...
              onChanged: (String? value) {
                setState(() {
                  leadsController.statusLifeStage = value;
                });
              },
