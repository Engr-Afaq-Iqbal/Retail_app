...
class FollowUpsByUserTile extends StatefulWidget {
  FollowUpsByUserTile(
      {Key? key,})
      : super(key: key);

  @override
  State<FollowUpsByUserTile> createState() => _FollowUpsByUserTileState();
}

class _FollowUpsByUserTileState extends State<FollowUpsByUserTile> {
  @override
