...
enum Description { KITCHEN_1, TEST }

final descriptionValues =
    EnumValues({"Kitchen 1": Description.KITCHEN_1, "test": Description.TEST});
...
enum IpAddress { THE_101010141 }

final ipAddressValues = EnumValues({"10.10.10.141": IpAddress.THE_101010141});

enum PrinterName { KOT_2 }

final printerNameValues = EnumValues({"KOT 2": PrinterName.KOT_2});
...
final typeValues =
    EnumValues({"modifier": Type.MODIFIER, "single": Type.SINGLE});
